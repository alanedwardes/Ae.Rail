...
namespace Ae.Rail.Migrations.Postgres
{
	...
	[Migration("202511150005_AddHumanReadableLocationNames")]
	public partial class _202511150005_AddHumanReadableLocationNames : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			// Recreate MV including human-readable origin/destination names from LocationSubsidiaryCode
		...
		{
			// Revert to previous MV without human-readable names
			migrationBuilder.Sql(@"drop view if exists trainservice_current;");
			migrationBuilder.Sql(@"drop materialized view if exists trainservice_v1 cascade;");
